...
final class Admin {
    ...
    public function cpbwc_enable()
    {
        ...
        <div>
            ...
            <br>
            <a href='https://coderpress.co/docs/custom-product-builder-for-woocommerce/?utm_source=plugin&utm_medium=product-edit-page&utm_campaign=cpbwc' target='_blank'>How to Setup❓</a>
            <br>
            <div>
            ...
            <a style='color: green; font-weight: bold;' href='https://coderpress.co/products/custom-product-builder-for-woocommerce/?utm_source=plugin&utm_medium=product-edit-page&utm_campaign=cpbwc' target='_blank'>GET PRO, TO GET EXTRA ORDINARY FEATURES👑</a>
        </div>
        ";
    ...
    public function plugin_row_meta( $plugin_meta, $plugin_file, $plugin_data, $status ) {
        ...
        if( isset( $plugin_data['slug'] ) && $plugin_data['slug'] == 'custom-product-builder-for-woocommerce' ) {
            $plugin_meta[] = sprintf(
                '<a href="%s" style="color: blue; font-weight: bold" target="_blank">%s</a>',
                esc_url( 'https://coderpress.co/products/custom-product-builder-for-woocommerce/?utm_source=plugin&utm_medium=plugins-page&utm_campaign=cpbwc' ),
                __( '👑Buy Pro' )
            );
            $plugin_meta[] = sprintf(
                '<a href="%s" style="color: green; font-weight: bold" target="_blank">%s</a>',
                esc_url( 'https://cpbw.coderpress.co/shop/?utm_source=plugin&utm_medium=plugins-page&utm_campaign=cpbwc' ),
                __( 'Demo' )
            );
            $plugin_meta[] = sprintf(
                '<a href="%s" style="color: green; font-weight: bold" target="_blank">%s</a>',
                esc_url( 'https://coderpress.co/docs/custom-product-builder-for-woocommerce/?utm_source=plugin&utm_medium=plugins-page&utm_campaign=cpbwc' ),
                __( 'How to setup❓' )
            );
        }
